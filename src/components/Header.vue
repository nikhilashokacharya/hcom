<template>
  <div>
    ...
    <div class="thirdrow">
      ...
      <img src="../assets/header-icons/cut.svg" class="fa"/>
      <img src="../assets/header-icons/copy.svg" class="fa"/>
      <img src="../assets/header-icons/paste.svg" class="fa"/>
      <img src="../assets/header-icons/find.svg" class="fa"/>
      <img src="../assets/header-icons/undo.svg" class="fa"/>
      <img src="../assets/header-icons/redo.svg" class="fa"/>
      <img src="../assets/header-icons/design-mode.svg" class="fa"/>
      <img src="../assets/header-icons/pj-explorer.svg" class="fa"/>
      <img src="../assets/header-icons/pj-property.svg" class="fa"/>
      <img src="../assets/header-icons/obj-browser.svg" class="fa"/>
      <img src="../assets/header-icons/tool-box.svg" class="fa"/>
      <img src="../assets/header-icons/help.svg" class="fa"/>
